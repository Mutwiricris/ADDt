...
@section("content")
  ...
  data-background="https://img.freepik.com/free-photo/winter-is-her-favorite-season-tender-silly-lovely-redhead-girl-embrace-herself-tilt-head-smi_1258-126225.jpg?uid=R103826523&ga=GA1.1.1883550326.1748688054&semt=ais_hybrid&w=740">
  <div class="container">
    <div class="row">
    <div class="col-xl-6 col-lg-7 col-md-10">
    <div class="tp-breadcrumb-content mr-80">
    <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 tp-text-common-white lh-1">Contact us</h2>
  ...
  <div class="container">
    ...
    <h3 class="mb-20 fs-xl-40 fs-sm-36 wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.2s">
    How to you <span class="text-italic fw-400 tp-ff-heading">find us</span></h3>
    ...
    <a href="tel:+(1)2246767430" class="fw-600 fs-16 ls-m-2 tp-text-theme-primary underline-black">+(1) 224
    676 7430</a>
    </div>
    </div>
    <div class="d-flex align-items-center mb-20">
    ...
    class="fw-600 fs-16 ls-m-2 tp-text-theme-primary underline-black">info@sepreninsurance.com</a>
    </div>
    </div>
    <div class="d-flex align-items-center mb-20">
    <span class="tp-contact-main-icon mr-15">
    ...
    fill="#1F3130" />
    <path
    d="M11 13.23C11 14.42 10.56 15.52 9.82001 16.39C8.83001 17.59 7.26 18.36 5.5 18.36L2.89 19.91C2.45 20.18 1.89 19.81 1.95 19.3L2.2 17.33C0.859997 16.4 0 14.91 0 13.23C0 11.47 0.940005 9.92 2.38 9C3.27 8.42 4.34 8.09003 5.5 8.09003C8.54 8.09003 11 10.39 11 13.23Z"
    fill="#1F3130" />
    </svg>
    </span>
    <div>
    ...
    <div class="tp-contact-slider-thumb tp-round-4 p-relative bg-position"
    data-background="https://highwayproperties.co.ke/wp-content/uploads/2019/08/highwayy-mall.jpg">
    <h4 class="fs-30 ls-m-3 tp-text-common-white mb-10">Highway mall<br> Nairobi, Kenya</h4>
    <span class="fw-600 fs-14 ls-m-2 tp-text-common-white d-inline-block mb-20">Monday - Friday 10 a.m.
      - 6 p.m.</span>
    ...
    <path d="M7 1L1 7L7 13" stroke="#1F3130" stroke-width="2" stroke-linecap="round"
    ...
    <path d="M7 1L13 7L7 13" stroke="#1F3130" stroke-width="2" stroke-linecap="round"
    stroke-linejoin="round" />
    </svg>
    </span>
    </div>
  ...
  <div class="container">
    ...
    <div class="col-lg-4">
    <div class="mb-30">
    <h2 class="mb-20 fs-40 fs-xl-35 fs-sm-30 pb-60 wow img-custom-anim-left" data-wow-duration="1.5s"
    data-wow-delay="0.2s">We love to hear<br> from <span class="text-italic fw-400 tp-ff-heading">you</span>
    </h2>
    ...
    @csrf
    <input class="tp-input mb-15" name="name" type="text" placeholder="Your full name*" required>
    <input class="tp-input mb-15" name="email" type="email" placeholder="Email address*" required>
    <input class="tp-input mb-15" name="website" type="url" placeholder="Your website">
    <textarea name="message" class="tp-textarea tp-input mb-10" placeholder="How can we help? Feel free to write here" required></textarea>
    <button type="submit"
    class="tp-btn-xl tp-round-4 fs-16 tp-bg-theme-primary w-100  d-block tp-text-common-white hover-text-white fw-500">Send
    your message</button>
    @if(session('success'))
    <p class="alert alert-success mt-20">{{ session('success') }}</p>
@endif
@if($errors->any())
    <ul class="alert alert-danger mt-20">
...
@endif
  ...
  <div class="tp-contact-map-box">
    <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.7897091555915!2d36.82249637496544!3d-1.301056098686583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f112f4b45b2d9%3A0x228a1bba09951347!2sHighwayy%20Mall!5e0!3m2!1sen!2ske!4v1750138580433!5m2!1sen!2ske"
